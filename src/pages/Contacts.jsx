        ...
        <>
            ...
            <div className="w-full h-screen bg-white">
                <div className="w-full flex justify-center items-center font-poppins pt-16">
                    ...
                    <section class="bg-white dark:bg-gray-900 z-30">
                        <div class="py-8 lg:py-16 px-4 mx-auto max-w-screen-md rounded-lg mt-10 lg:mt-20">
                            <h2 class="mb-4 text-4xl tracking-tight font-extrabold text-center text-transparent bg-clip-text bg-gradient-to-r from-[#01aae7] to-[#0974f1]">Give me a feedback !</h2>
                            ...
                            <form onSubmit={handleSubmit} class="space-y-8">
                                ...
                                <button type="submit" disabled={state.submitting} class="btn btn-primary py-3 px-5 text-sm font-medium text-center text-white rounded-lg bg-blue-700 hover:bg-blue-800 sm:w-fit focus:ring-4 focus:outline-none focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">Send message</button>
                            </form>
                        </div>
                    </section>
                </div>
